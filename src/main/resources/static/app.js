...
async function initBlueprintPage(){
 ...
 function applySourceContext(){const saved=ctx.knowledgeSources||[];sourceIds.forEach(function(v){const e=document.getElementById('source-'+v);if(e)e.checked=saved.includes(v)});if(!saved.length){const e=document.getElementById('source-SYLLABUS');if(e)e.checked=true}}
 function add(name,type,count,marks,neg,diff,topic){
   ...
   row.innerHTML='<input class="sec-name col-span-3 field rounded-xl border px-3 py-2.5 text-xs" value="'+esc(name)+'" required><select class="sec-type col-span-2 field rounded-xl border px-3 py-2.5 text-xs"><option>MCQ</option><option>NUMERICAL</option><option>ASSERTION_REASON</option><option>SHORT_ANSWER</option><option>MATCHING</option><option>STATEMENT_BASED</option><option>CASE_BASED</option><option>MIXED</option></select><input class="sec-count field rounded-xl border px-2 py-2.5 text-xs" type="number" min="1" value="'+count+'"><input class="sec-marks field rounded-xl border px-2 py-2.5 text-xs" type="number" min="1" value="'+marks+'"><input class="sec-neg field rounded-xl border px-2 py-2.5 text-xs" type="number" min="0" step=".25" value="'+neg+'"><select class="sec-diff field rounded-xl border px-2 py-2.5 text-xs"><option>EASY</option><option>MEDIUM</option><option>HARD</option></select><input class="sec-topic col-span-2 field rounded-xl border px-3 py-2.5 text-xs" placeholder="Topic" value="'+esc(topic)+'"><button type="button" class="remove rounded-xl border px-2 text-xs">✕</button>';
   ...
   card.innerHTML='<div class="mb-3 flex justify-between"><b>'+esc(name)+'</b><button type="button" class="section-remove text-rose-600">Remove</button></div><input class="mobile-sec-name field w-full rounded-xl border px-3 py-3 text-sm mb-2" value="'+esc(name)+'"><select class="mobile-sec-type field w-full rounded-xl border px-3 py-3 text-sm mb-2"><option>MCQ</option><option>NUMERICAL</option><option>ASSERTION_REASON</option><option>SHORT_ANSWER</option><option>MATCHING</option><option>STATEMENT_BASED</option><option>CASE_BASED</option><option>MIXED</option></select><div class="grid grid-cols-2 gap-2"><input class="mobile-sec-count field rounded-xl border px-3 py-3" type="number" min="1" value="'+count+'"><input class="mobile-sec-marks field rounded-xl border px-3 py-3" type="number" min="1" value="'+marks+'"><input class="mobile-sec-neg field rounded-xl border px-3 py-3" type="number" min="0" step=".25" value="'+neg+'"><select class="mobile-sec-diff field rounded-xl border px-3 py-3"><option>EASY</option><option>MEDIUM</option><option>HARD</option></select></div><input class="mobile-sec-topic field w-full rounded-xl border px-3 py-3 mt-2" placeholder="Topic" value="'+esc(topic)+'">';
 ...
 add('Section A: Mixed Pattern','MIXED',5,1,0,'MEDIUM');add('Section B: Numerical','NUMERICAL',2,4,0,'MEDIUM');add('Section C: Short Answer','SHORT_ANSWER',2,3,0,'MEDIUM');
